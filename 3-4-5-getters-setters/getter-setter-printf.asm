...
get_char:
    ...
    mov eax, dword [sample_obj + char_y];
   ; PRINTF32 `%c\n\x0`, eax
...
set_int:
    ...
    mov dword [sample_obj + int_x], 2000;
...
set_string:
    ...
    mov dword [sample_obj + string_s], "Are ";
    mov dword [sample_obj + string_s + 4], "you ";
    mov dword [sample_obj + string_s + 8], "sure";
    mov dword [sample_obj + string_s + 12], "?";
